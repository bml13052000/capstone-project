...
//   double _originLatitude = 12.8618987;
//   double _originLongitude = 77.6607389;
...
//   _addMarker(LatLng position, String id, BitmapDescriptor descriptor, String text) {
//     MarkerId markerId = MarkerId(id);
//     Marker marker =
//         Marker(markerId: markerId, icon: descriptor, position: position, infoWindow: InfoWindow(title: text));
