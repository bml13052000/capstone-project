...
class DispRoute extends StatefulWidget {
  var coordinates;
  DispRoute(this.coordinates);

  @override
  _DispRouteState createState() => _DispRouteState();
}
...
class _DispRouteState extends State<DispRoute> {
